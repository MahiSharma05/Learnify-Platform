...
import com.learnify.paymentservice.event.PaymentSuccessEvent;
...
//                    .amount(order.get("amount"))
    ...
    public PaymentResponse processPayment(PaymentRequest request,
        ...
        log.info("[PaymentService] Payment processed — id={} student={} amount={}",
                saved.getId(), saved.getStudentId(), saved.getAmount());
...
// 🔥 NEW EVENT
        PaymentSuccessEvent event = PaymentSuccessEvent.builder()
                ...
                .paymentMode(saved.getMode().name())
    ...
    public SubscriptionResponse subscribe(SubscriptionRequest request,
        ...
        subscription.setPaymentId(paymentId);
            ...
            log.info("[PaymentService] Subscription created — id={} student={} plan={}",
                    savedSub.getId(), savedSub.getStudentId(), savedSub.getPlan());

// 🔥 NEW EVENT
            PaymentSuccessEvent event = PaymentSuccessEvent.builder()
                    .studentId(savedSub.getStudentId())
                    .studentEmail(savedSub.getStudentEmail())
                    .amount(savedSub.getAmountPaid())
                    .currency("INR")
                    .paymentType("SUBSCRIPTION")
                    .subscriptionPlan(savedSub.getPlan().name())
