package com.learnify.paymentservice.config;
...
/**
 * RabbitMQConfig — NEW FILE (payment-service)
 *
 * Same exchange/queue topology as all other services.
 * Only the package declaration differs per service.
 */
@Configuration
